...
public class CollectionMethods {
    ...
    public static void main(String[] args) {
        ...
        //Find the max and min elements; this means different things depending on the way the Comparable interface is implemented:
        ...
        //Keep all the elements that are in both c2 an c3 (an intersection of sets):
        c2.retainAll(c3);
